...
def print_process_usage():
    ...
    print("Usage: " +
          argv[0] + " process [-h|--help] <midi files folder> <output file>")
...
def print_train_usage():
    ...
    print("Usage: " +
          argv[0] + " train <processed midis file> <neural network weights folder> <number of epochs>")
...
def print_generate_usage():
    ...
    print("Usage: " +
          argv[0] + " generate <processed midis file> <neural networks weights> <output midi file>")
...
def check_instrument(instrument):
    if instrument not in instruments:
        print("Invalid instrument " + instrument +
              ", check the list of available instruments:")
...
def print_usage():
    print("Qphrygian is a tool for music composition using AI")
